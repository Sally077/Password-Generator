...
pass += strings.specialCharacters;
console.log(specialCharacters);

var lower = confirm("Would you like lowercase characters : ");
if (lowerCasedCharacters === true)
pass += strings.lowerCasedCharacters;
console.log(lowerCasedCharacters);

var upper = confirm("Would you like uppercase characters :");
if (upperCasedCharacters === true) {
pass += strings.upperCasedCharacters;
console.log(upperCasedCharacters);
};
var numericCharacters = confirm("Would you like numbers included in your password :");
if (numericCharacters === true) {
pass += strings.numericCharacters;
console.log(numericCharacters);
};
